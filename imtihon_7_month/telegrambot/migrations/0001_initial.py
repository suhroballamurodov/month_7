    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='telegrambot.ordermodel')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='telegrambot.productmodel')),
            ],
        ),
        migrations.AddField(
            model_name='ordermodel',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='telegrambot.usermodel'),
        ),
        migrations.CreateModel(
            name='LocationModel',
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='telegrambot.usermodel')),
            ],
        ),
    ]
